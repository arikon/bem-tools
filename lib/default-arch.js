...
exports.Arch = INHERIT({
    ...
    createCommonNodes: function() {
        ...
        this.arch.setNode(LevelNode.createInstance('blocks'),
    ...
    createBundlesLevelsNodes: function(parent, children) {
        ...
        return this.getBundlesLevels().then(function(levels) {
            return levels.map(function(level) {
                return _this.arch.setNode(BundlesLevelNode.createInstance(_this.absolutePath(level)), parent, children);
            });
        });
    },
